...
!function (e) {
    ...
    return function e(t, r, n) {
        ...
        1: [function (e, t, r) {
            var n = e("github-calendar-parser"), a = e("elly"), o = e("add-subtract-date"), u = e("formatoid");
            t.exports = function (e, t, r) {
                ...
                return function s() {
                    return fetch(r.proxy("https://github.com/" + t)).then(function (e) {
                        ...
                        if (c.querySelector(".float-left.text-gray").innerHTML = r.summary_text, c.querySelector("include-fragment")) setTimeout(s, 500); else {
                            if (!0 === r.responsive) {
                                var l = c.querySelector("svg.js-calendar-graph-svg"), d = l.getAttribute("width"),
            ...
            var a = e("iterate-object"), o = e("sliced");
            n.$$ = function (e, t) {
            ...
            var n = e("months"), a = e("days"), o = e("fillo"), u = {
                YYYY: function (e, t) {
            ...
            t.exports = function (e) {
                ...
                return e.split("\n").slice(2).map(function (e) {
                    ...
                    var o = e.match(/fill="(#[a-z0-9]+)"/), u = e.match(/data-date="([0-9\-]+)"/),
                        s = e.match(/data-count="([0-9]+)"/);
                    if (o = o && o[1], u = u && u[1], s = s && +s[1], o) {
                        var i = {fill: o, date: new Date(u), count: s, level: n.indexOf(o)};
